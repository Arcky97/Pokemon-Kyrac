module QuestModule
  ...
  Quest4 = {
    ...
    :QuestDescription => "You enbark on your Journey through the Kyrac Region. Even if you lived here since you were born, you know very little about this region.",
    :RewardString => "Your official Starter Pokémon!"
  }

  Quest5 = {
    :ID => "5",
    :Name => "The garden's maze!",
    :QuestGiver => "Yourself",
