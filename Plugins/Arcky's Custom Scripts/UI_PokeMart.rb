...
class PokemonMartAdapter
    ...
    def addItem(item)
      #$item_log.register(item) if $bag.add(item, 0)
      return $bag.add(item)
    end
  ...
  class PokemonMart_Scene
    ...
    def pbStartBuyOrSellScene(buying, stock, adapter)
      ...
      @sprites["itemtextwindow"].shadowColor = Color.new(72, 80, 88)
      @sprites["itemtextwindow"].windowskin = nil
      @sprites["helpwindow"] = Window_AdvancedTextPokemon.new("")
      @sprites["helpwindow"].setSkin("Graphics/Windowskins/MainSpeech")
      ...
      @sprites["moneywindow"].shadowColor = Color.new(72, 80, 88)
      ...
      @sprites["qtywindow"].shadowColor = Color.new(72, 80, 88)
    ...
    def pbStartSellScene2(bag, adapter)
      ...
      @sprites["helpwindow"].shadowColor = Color.new(72, 80, 88)
      pbBottomLeftLines(@sprites["helpwindow"], 1)
      @sprites["moneywindow"] = Window_AdvancedTextPokemon.new("")
      pbPrepareWindow(@sprites["moneywindow"])
      @sprites["moneywindow"].setSkin("Graphics/Windowskins/MainSystem")
    ...
    def pbDisplay(msg, brief = false)
      ...
      cw.setSkin("Graphics/Windowskins/MainSpeech")
    ...
    def pbConfirm(msg)
      ...
      dw.setSkin("Graphics/Windowskins/MainSpeech")
    ...
    def pbChooseNumber(helptext, item, maximum)
      ...
      helpwindow.setSkin("Graphics/Windowskins/MainSystem")
  ...
  class PokemonMartScreen
    ...
    #
    #===============================================================================
    def pbPokemonMart(position,stock, speech = nil, cantsell = false)
      $position = position
      stock.delete_if { |item| GameData::Item.get(item).is_important? && $bag.has?(item) }
      commands = []
      cmdBuy  = -1
      ...
      loop do
        if cmdBuy >= 0 && cmd == cmdBuy
          ...
          pbMessage(_INTL("\\xnb[Salesman]Do come again!"))
          break
        end
        cmd = pbMessage(_INTL("\\xnb[Salesman]Is there anything else I can do for you?"), commands, cmdQuit + 1)
      end
